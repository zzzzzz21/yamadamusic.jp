...
//
$mail_sys = "info@yamadamusic.jp";	// 管理者のメールアドレス
$from_name = "一般財団法人 山田音楽財団メールフォーム";	// メール送信者の表示
$from_mail = "info@yamadamusic.jp";	// メール送信者のメールアドレス（返信先）
...
if (!$confirm_html) {
	$confirm_html = "form-confirm.html";		// 確認画面のファイル名
}
if (!$finish_html) {
	$finish_html = "form-transfer.html";		// 終了画面のファイル名
}
// ユーザー向け
if (!$subject) {
